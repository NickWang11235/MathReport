...
\begin{document}
	...
	\paragraph
		...
		\indent Canceling out similar terms under the radicant:$$A =2\pi \int_7^{16} \sqrt{256-x^2} \sqrt{\frac{256}{256-x^2}}dx$$
		\indent Pulling out the constant 256:$$A =2\pi \int_7^{16} \sqrt{256-x^2} 16\sqrt{\frac{1}{256-x^2}}dx$$
		\indent Moving the constants out of the integral:$$A =32\pi \int_7^{16}\sqrt{256-x^2} \sqrt{\frac{1}{256-x^2}}dx$$
		\indent Rewriting radicant as exponents:$$A =32\pi \int_7^{16}{(256-x^2)} ^{1/2}{(256-x^2)}^{-1/2}dx$$
		\indent Combining similar terms by adding up the coefficient:$$A =32\pi \int_7^{16}{(256-x^2)}^0 dx$$
	...
	\section{Conclusion}
	\paragraph
		\indent This problem investigates the properties of surface areas of spheres by connecting them to real life situations. During the calculation we investigated the properties of a sphere without using any equation specific to spheres and derived at the result that 5000 woks would require $72\pi$ liters of paint. The same process if used more generally can be used to derive the formula of the surface area of spheres: $4\pi r^2$.
